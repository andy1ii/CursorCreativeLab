...
function buildCellData() {
  ...
  let targetDensity = logoInternalDensity;
      ...
      if (inLogo || nearEdge) {
        ...
        if (packet > 0.25) { 
          ...
          if (seed < 25) {
            ...
            fill(cR, cG, cB, nearEdge ? 255 : 220);
            noStroke();
            text((seed % 2 === 0) ? '1' : '0', 0, 0);
          } else if (seed < 50) {
            scale(dynScale); 
            fill(cR, cG, cB, nearEdge ? 255 : 200);
            noStroke();
            ...
            scale(dynScale); 
            noFill();
            stroke(cR, cG, cB, nearEdge ? 255 : 180);
            strokeWeight(1.0);
            rect(0, 0, gridSize * 0.4, gridSize * 0.4);
          } else if (seed < 88) {
            scale(dynScale); 
            fill(cR, cG, cB, nearEdge ? 245 : 190);
            noStroke();
